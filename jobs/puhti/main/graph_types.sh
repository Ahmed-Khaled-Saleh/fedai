...
#SBATCH --array=0-11          # Number of algorithms (0 to N-1)
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
CURRENT_GRAPH_TYPE=$(echo $current_pair | cut -d'|' -f4)
...
python main.py \
    ...
    algorithm.graph_type=$CURRENT_GRAPH_TYPE