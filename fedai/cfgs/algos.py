...
# %% auto #0
__all__ = ['AlgorithmConfig', 'FedAvgConfig', 'FedAvgFTConfig', 'FedProxConfig', 'pFedMeConfig', 'IFCAConfig', 'DittoConfig',
           'FedUConfig', 'APFLConfig', 'FedALA', 'FedPerConfig', 'LGFedAvgConfig', 'FedRepConfig', 'FedRodConfig',
           'FedBabuConfig', 'FedGPFLConfig', 'FedDBEConfig', 'SFMTLConfig', 'PerFedAvgConfig']
...
# %% ../../nbs/7a_cfgs.algos.ipynb #a5791be6
@dataclass
class AlgorithmConfig:
    name: str


# %% ../../nbs/7a_cfgs.algos.ipynb #82a46664
@dataclass
...
# %% ../../nbs/7a_cfgs.algos.ipynb #1a6ca8f6
@dataclass
...
# %% ../../nbs/7a_cfgs.algos.ipynb #15fa4e27
@dataclass
...
# %% ../../nbs/7a_cfgs.algos.ipynb #1f2462f7
@dataclass
...
# %% ../../nbs/7a_cfgs.algos.ipynb #5e6e4490
@dataclass
...
# %% ../../nbs/7a_cfgs.algos.ipynb #10693847
@dataclass
