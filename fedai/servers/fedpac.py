# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/11s_server.fedpac.ipynb.

# %% auto #0
__all__ = ['ServerFedPAC']

# %% ../../nbs/11s_server.fedpac.ipynb #95d57626
...
# %% ../../nbs/11s_server.fedpac.ipynb #c4456ff3
@AlgorithmRegistry.register_server("fedpac")
class ServerFedPAC(BaseServer):
    def __init__(self,
                 cfg,
                 client_selector,
                 client_cls,
...
# %% ../../nbs/11s_server.fedpac.ipynb #0777b0b3
@patch
def client_fn(self: ServerFedPAC, id, comm_round, client_state):
...
# %% ../../nbs/11s_server.fedpac.ipynb #8324efba
@patch
def init_training(self: ServerFedPAC):
    len_clients_ds = {}
    global_mean = 0
...
# %% ../../nbs/11s_server.fedpac.ipynb #99c07788
@patch
def train(self: ServerFedPAC):
...
# %% ../../nbs/11s_server.fedpac.ipynb #ce0e22b2
@patch
def aggregate(self: ServerFedPAC, lst_active_ids, comm_round, len_clients_ds):
    m_t = sum(len_clients_ds.values())
