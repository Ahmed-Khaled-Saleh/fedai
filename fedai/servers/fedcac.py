# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/11t_server.fedcac.ipynb.

# %% auto #0
__all__ = ['ServerFedCAc']

# %% ../../nbs/11t_server.fedcac.ipynb #95d57626
...
# %% ../../nbs/11t_server.fedcac.ipynb #c4456ff3
@AlgorithmRegistry.register_server("fedcac")
class ServerFedCAc(BaseServer):
    def __init__(self,
                 cfg,
                 client_selector,
                 client_cls,
...
# %% ../../nbs/11t_server.fedcac.ipynb #0777b0b3
@patch
def client_fn(self: ServerFedCAc, id, comm_round, client_state):
...
# %% ../../nbs/11t_server.fedcac.ipynb #8324efba
@patch
def init_training(self: ServerFedCAc):
    len_clients_ds = {}
    global_mean = 0
...
# %% ../../nbs/11t_server.fedcac.ipynb #99c07788
@patch
def train(self: ServerFedCAc):
...
# %% ../../nbs/11t_server.fedcac.ipynb #ce0e22b2
@patch
def aggregate(self: ServerFedCAc, lst_active_ids, comm_round, len_clients_ds):
    m_t = sum(len_clients_ds.values())
