"""The core abstraction for `FedALA` server: https://arxiv.org/abs/2212.01197"""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/11k_server.fedala.ipynb.

# %% auto #0
__all__ = ['ServerFedALA']

# %% ../../nbs/11k_server.fedala.ipynb #95d57626
...
# %% ../../nbs/11k_server.fedala.ipynb #c4456ff3
@AlgorithmRegistry.register_server("fedala")
class ServerFedALA(BaseServer):
    def __init__(self,
                 cfg,
                 client_selector,
                 client_cls,
...
# %% ../../nbs/11k_server.fedala.ipynb #3e572e09
@patch
def client_fn(self: ServerFedALA, id, comm_round, client_state):
    ...
    client.local_initialization(self.model)

    return client


# %% ../../nbs/11k_server.fedala.ipynb #ce0e22b2
@patch
def aggregate(self: ServerFedALA, lst_active_ids, comm_round, len_clients_ds):
