...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/04_data.ipynb.ipynb.

# %% auto 0
__all__ = ['PROMPT_DICT', 'load_jsonl', 'DefaultToken', 'LLMDataCollator', 'MTLDataSet', 'split_by_category', 'train_eval_split',
           'split_tasks_among_clients', 'get_dolly']

# %% ../nbs/04_data.ipynb.ipynb 15
import copy
