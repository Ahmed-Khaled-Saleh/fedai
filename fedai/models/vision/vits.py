...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../../nbs/02f_models.vision.vits.ipynb.

# %% auto #0
__all__ = ['pair', 'PreNorm', 'FeedForward', 'Attention', 'Transformer', 'ViTBackbone', 'ViT', 'LSA', 'SPT', 'ViTSmallBackbone',
           'ViTSmall', 'timm_vit_model', 'ViTPretrained', 'make_vit']

# %% ../../../nbs/02f_models.vision.vits.ipynb #efcba6e2
...
# %% ../../../nbs/02f_models.vision.vits.ipynb #185fdd62
def pair(t):
...
# %% ../../../nbs/02f_models.vision.vits.ipynb #cc3e8cd2
...
# %% ../../../nbs/02f_models.vision.vits.ipynb #ff09c3a2
class LSA(nn.Module):
    def __init__(self, dim, heads = 8, dim_head = 64, dropout = 0.):
        super().__init__()
        inner_dim = dim_head *  heads
...
# %% ../../../nbs/02f_models.vision.vits.ipynb #1ee4b5ef
import timm
import torch
import torch.nn as nn

# %% ../../../nbs/02f_models.vision.vits.ipynb #90c7fcb0
...
# %% ../../../nbs/02f_models.vision.vits.ipynb #d765e7e0
...
# %% ../../../nbs/02f_models.vision.vits.ipynb #50c59020
from typing import Union, Literal
from .registery import register_model

# %% ../../../nbs/02f_models.vision.vits.ipynb #1f8fce8b
@register_model(
    name='vit',
