...
# %% auto 0
__all__ = ['AgentRole', 'Agent', 'FLAgent', 'Fedu', 'PeftAgent', 'FedSophiaAgent', 'PadgAgent', 'AgentMira']
...
@patch
def aggregate(self: Fedu, lst_active_ids, comm_round, len_clients_ds, one_model= False):
