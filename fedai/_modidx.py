  ...
  'syms': { 'fedai.FLearner': { 'fedai.FLearner.FLearner': ('flearner.html#flearner', 'fedai/FLearner.py'),
            ...
            'fedai.federated.agents': { 'fedai.federated.agents.Agent': ('federated.agents.html#agent', 'fedai/federated/agents.py'),
                                        ...
                                        'fedai.federated.agents.pFedMe.communicate': ( 'federated.agents.html#pfedme.communicate',
                                                                                       'fedai/federated/agents.py'),
                                        'fedai.federated.agents.pFedMe.evaluate_personalized': ( 'federated.agents.html#pfedme.evaluate_personalized',
                                                                                                 'fedai/federated/agents.py'),
                                        'fedai.federated.agents.pFedMe.fit': ( 'federated.agents.html#pfedme.fit',
                                                                               'fedai/federated/agents.py'),
                                        'fedai.federated.agents.pFedMe.local_evaluate_personalized': ( 'federated.agents.html#pfedme.local_evaluate_personalized',
                                                                                                       'fedai/federated/agents.py'),
                                        'fedai.federated.agents.pFedMe.per_train_test_stats': ( 'federated.agents.html#pfedme.per_train_test_stats',
                                                                                                'fedai/federated/agents.py'),
                                        'fedai.federated.agents.pFedMe.save_init_global': ( 'federated.agents.html#pfedme.save_init_global',
                                                                                            'fedai/federated/agents.py'),
