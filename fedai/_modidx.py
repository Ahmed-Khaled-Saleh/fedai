...
d = { 'settings': { 'branch': 'main',
                ...
                'lib_path': 'fedai'},
  'syms': { 'fedai.FLearner': {},
            'fedai.clients': { 'fedai.clients.Client_mira': ('clients.html#client_mira', 'fedai/clients.py'),
            ...
            'fedai.data.core': { 'fedai.data.core.FDblock': ('data.core.html#fdblock', 'fedai/data/core.py'),
                                 'fedai.data.core.FDblock.__init__': ('data.core.html#fdblock.__init__', 'fedai/data/core.py'),
                                 'fedai.data.core.FDblock.check': ('data.core.html#fdblock.check', 'fedai/data/core.py'),
                                 'fedai.data.core.FDblock.load_data': ('data.core.html#fdblock.load_data', 'fedai/data/core.py'),
                                 'fedai.data.core.FDblock.load_partition': ('data.core.html#fdblock.load_partition', 'fedai/data/core.py'),
                                 'fedai.data.core.FDblock.load_split': ('data.core.html#fdblock.load_split', 'fedai/data/core.py'),
                                 'fedai.data.core.FDblock.partition': ('data.core.html#fdblock.partition', 'fedai/data/core.py'),
                                 'fedai.data.core.FDblock.save_partitions': ( 'data.core.html#fdblock.save_partitions',
                                                                              'fedai/data/core.py'),
                                 'fedai.data.core.FDblock.save_partitions_np': ( 'data.core.html#fdblock.save_partitions_np',
                                                                                 'fedai/data/core.py'),
                                 'fedai.data.core.FDblock.split_data': ('data.core.html#fdblock.split_data', 'fedai/data/core.py'),
                                 'fedai.data.core.FDblock.tensorify': ('data.core.html#fdblock.tensorify', 'fedai/data/core.py')},
            ...
            'fedai.vision.data': { 'fedai.vision.data.FvisionBlock.load_data': ( 'vision.data.html#fvisionblock.load_data',
