  ...
  'syms': { 'fedai.FLearner': { 'fedai.FLearner.FLearner': ('flearner.html#flearner', 'fedai/FLearner.py'),
            ...
            'fedai.vision.models': { 'fedai.vision.models.CIFAR10CNN': ('vision.models.html#cifar10cnn', 'fedai/vision/models.py'),
                                     ...
                                     'fedai.vision.models.MNISTCNN.forward': ( 'vision.models.html#mnistcnn.forward',
                                                                               'fedai/vision/models.py')},
            'fedai.wnadb_writer': { 'fedai.wnadb_writer.WandbWriter': ('wandb_writer.html#wandbwriter', 'fedai/wnadb_writer.py'),
                                    'fedai.wnadb_writer.WandbWriter.__init__': ( 'wandb_writer.html#wandbwriter.__init__',
                                                                                 'fedai/wnadb_writer.py'),
                                    'fedai.wnadb_writer.WandbWriter.finish': ( 'wandb_writer.html#wandbwriter.finish',
                                                                               'fedai/wnadb_writer.py'),
                                    'fedai.wnadb_writer.WandbWriter.write': ( 'wandb_writer.html#wandbwriter.write',
                                                                              'fedai/wnadb_writer.py')}}}
