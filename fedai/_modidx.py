  ...
  'syms': { 'fedai.FLearner': { 'fedai.FLearner.FLearner': ('flearner.html#flearner', 'fedai/FLearner.py'),
            ...
            'fedai.federated.agents': { 'fedai.federated.agents.Agent': ('federated.agents.html#agent', 'fedai/federated/agents.py'),
                                        ...
                                        'fedai.federated.agents.PeftAgent.save_state_': ( 'federated.agents.html#peftagent.save_state_',
                                                                                          'fedai/federated/agents.py')},
            'fedai.learner_utils': { 'fedai.learner_utils.client_fn': ('learner_utils.html#client_fn', 'fedai/learner_utils.py'),
                                     'fedai.learner_utils.get_block': ('learner_utils.html#get_block', 'fedai/learner_utils.py'),
            ...
            'fedai.trainers': { 'fedai.trainers.FedSophiaTrainer': ('trainers.ipynb.html#fedsophiatrainer', 'fedai/trainers.py'),
                                'fedai.trainers.FedSophiaTrainer.__init__': ( 'trainers.ipynb.html#fedsophiatrainer.__init__',
                                                                              'fedai/trainers.py'),
                                'fedai.trainers.FedSophiaTrainer._run_batch': ( 'trainers.ipynb.html#fedsophiatrainer._run_batch',
                                                                                'fedai/trainers.py'),
                                'fedai.trainers.FedSophiaTrainer._run_epoch': ( 'trainers.ipynb.html#fedsophiatrainer._run_epoch',
                                                                                'fedai/trainers.py'),
                                'fedai.trainers.FedSophiaTrainer.estimate_hessian': ( 'trainers.ipynb.html#fedsophiatrainer.estimate_hessian',
                                                                                      'fedai/trainers.py'),
                                'fedai.trainers.FedSophiaTrainer.get_next_train_batch': ( 'trainers.ipynb.html#fedsophiatrainer.get_next_train_batch',
                                                                                          'fedai/trainers.py'),
                                'fedai.trainers.LLMTrainer': ('trainers.ipynb.html#llmtrainer', 'fedai/trainers.py'),
            ...
            'fedai.utils': { 'fedai.utils.LazyList': ('utils.ipynb.html#lazylist', 'fedai/utils.py'),
                             ...
                             'fedai.utils.draw_matrix': ('utils.ipynb.html#draw_matrix', 'fedai/utils.py'),
