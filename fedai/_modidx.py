  ...
  'syms': { 'fedai.FLearner': { 'fedai.FLearner.FLearner': ('flearner.html#flearner', 'fedai/FLearner.py'),
            ...
            'fedai.federated.agents': { 'fedai.federated.agents.Agent': ('federated.agents.html#agent', 'fedai/federated/agents.py'),
                                        ...
                                        'fedai.federated.agents.DMTL.aggregate': ( 'federated.agents.html#dmtl.aggregate',
                                                                                   'fedai/federated/agents.py'),
                                        'fedai.federated.agents.DMTL.head_similarity': ( 'federated.agents.html#dmtl.head_similarity',
                                                                                         'fedai/federated/agents.py'),
                                        'fedai.federated.agents.DMTL.repr_similarity': ( 'federated.agents.html#dmtl.repr_similarity',
                                                                                         'fedai/federated/agents.py'),
                                        ...
                                        'fedai.federated.agents.PeftAgent.save_state_': ( 'federated.agents.html#peftagent.save_state_',
                                                                                          'fedai/federated/agents.py'),
                                        'fedai.federated.agents.get_coalitions': ( 'federated.agents.html#get_coalitions',
                                                                                   'fedai/federated/agents.py'),
                                        'fedai.federated.agents.get_shapley_vals': ( 'federated.agents.html#get_shapley_vals',
                                                                                     'fedai/federated/agents.py'),
                                        'fedai.federated.agents.repr_alignment': ( 'federated.agents.html#repr_alignment',
                                                                                   'fedai/federated/agents.py')},
