...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/10y_clients.perFedAvg.ipynb.

# %% auto #0
__all__ = ['ClientPerFedAvg']

# %% ../../nbs/10y_clients.perFedAvg.ipynb #de117c85
import math
...
# %% ../../nbs/10y_clients.perFedAvg.ipynb #fe628af3
...
# %% ../../nbs/10y_clients.perFedAvg.ipynb #1cf00df7
@patch
...
# %% ../../nbs/10y_clients.perFedAvg.ipynb #f8f56932
@patch
...
# %% ../../nbs/10y_clients.perFedAvg.ipynb #7cf7eff5
@patch
def fit(self: ClientPerFedAvg) -> None:
    self.train_step()
    self.train_step()

# %% ../../nbs/10y_clients.perFedAvg.ipynb #40075099
@patch
...
# %% ../../nbs/10y_clients.perFedAvg.ipynb #7f205b4c
@patch
