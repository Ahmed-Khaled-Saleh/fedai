# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/10t_clients.fedcac.ipynb.

# %% auto #0
__all__ = ['ClientFedCAC']

# %% ../../nbs/10t_clients.fedcac.ipynb #95d57626
...
# %% ../../nbs/10t_clients.fedcac.ipynb #c4456ff3
@AlgorithmRegistry.register_client("fedcac")
class ClientFedCAC(BaseClient):
    def __init__(self,
...
# %% ../../nbs/10t_clients.fedcac.ipynb #f251b5b1
@patch
def fit(self: ClientFedCAC):
...
# %% ../../nbs/10t_clients.fedcac.ipynb #3e9b73f5
@patch
def train_test_stats(self: ClientFedCAC, batch: dict) -> tuple:
...
# %% ../../nbs/10t_clients.fedcac.ipynb #5443f82d
@patch
def evaluate_local(self: ClientFedCAC, loader= 'train') -> dict:
    total_loss = 0
    lst_metrics = []
...
# %% ../../nbs/10t_clients.fedcac.ipynb #91932e11
@patch
def save_state(self: ClientFedCAC, save_to_disk= False):  
